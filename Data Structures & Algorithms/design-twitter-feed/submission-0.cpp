...
class Twitter {
    ...
    array<int, 10001> tweet_userids; // index by tweet_id
    // index by user, followee id
    array<array<bool, 101>, 101> follows{};
